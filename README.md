...
In the left-hand column, you'll see a *review application* for each open pull request on this repository. You can instruct the Atom package to use one of these servers by opening the package's settings page and assigning the base URL.
