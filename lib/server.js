...
class Server {
  ...
  async start () {
    ...
    const iceServers = JSON.parse(await request.post(`https://${this.twilioAccount}:${this.twilioAuthToken}@api.twilio.com/2010-04-01/Accounts/${this.twilioAccount}/Tokens.json`))
